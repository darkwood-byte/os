...
SOURCES = main.c print_k.c SBI.c mem.c str.c oa.c memory.c trap_k.c pcb_k.c program_k.c app.c sockets.c malloc.c
OBJECTS = $(SOURCES:%.c=build/%.o) bronx.o init.o snak.o test.o
